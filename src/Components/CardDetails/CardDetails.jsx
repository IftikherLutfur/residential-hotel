...
const CardDetails = () => {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 items-center mt-3 mx-4">
                <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 dark:bg-gray-50 dark:text-gray-800">
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex flex-wrap items-center mt-2 mb-1 space-x-2">
                            ...
                            <span className="dark:text-gray-600">{card.avg_rate}</span>
                        </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-4 bg-slate-200 px-4 py-2 rounded-lg border-2 ">


                        <div >
                            <img className="w-20 h-16 rounded-full border-2" src={card.user_img} />
                        </div>
                        <div>
                            ...
                            <h3><small>{card.review1}</small></h3>
                        </div>
                    </div>
                    <div className="flex gap-4 bg-slate-200 px-4 py-2 rounded-lg border-2 ">
                        ...
                        <div>
                            ...
                            <h3><small>{card.review2}</small></h3>
                        </div>
                    </div>
                 <div className="flex gap-4 bg-slate-200 px-4 py-2 rounded-lg border-2 ">
                        ...
                        <div>
                            ...
                            <h3><small>{card.review3}</small></h3>
                        </div>
                    </div>
